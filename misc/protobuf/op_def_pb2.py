...
import full_type_pb2 as full__type__pb2
...
_OPDEF_ARGDEF.fields_by_name['handle_data'].message_type = resource__handle__pb2._RESOURCEHANDLEPROTO_DTYPEANDSHAPE
_OPDEF_ARGDEF.fields_by_name['experimental_full_type'].message_type = full__type__pb2._FULLTYPEDEF
